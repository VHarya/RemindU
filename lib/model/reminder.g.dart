...
extension ReminderQuerySortBy on QueryBuilder<Reminder, Reminder, QSortBy> {
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> sortByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterSortBy> sortByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderQuerySortThenBy
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> thenByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterSortBy> thenByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.desc);
    });
  }
...
extension ReminderQueryWhereDistinct
  ...
  QueryBuilder<Reminder, Reminder, QDistinct> distinctByNote(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderQueryProperty
  ...
  QueryBuilder<Reminder, int, QQueryOperations> categoryIDProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, String, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
